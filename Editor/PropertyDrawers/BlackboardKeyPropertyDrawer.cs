        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property) {
            if (property.propertyType != SerializedPropertyType.ArraySize) {
                ...
                container.AddManipulator(new ContextualMenuManipulator((evt) => {
                    evt.menu.AppendAction("Delete", (x) => BehaviourTreeEditorWindow.Instance.CurrentSerializer.DeleteBlackboardKey(property.displayName, BlackboardScope.Local), DropdownMenuAction.AlwaysEnabled);
                }));
